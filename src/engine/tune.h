...
VALUE(NMP_DIVISOR_EVAL, 207, 50, 500, 20, true)

VALUE(LMP_BASE, 3, 3, 3, 0, false)

VALUE(FP_COEF, 82, 50, 500, 20, true)
VALUE(FP_BIAS, 55, 0, 250, 20, true)
VALUE(FP_DEPTH, 10, 8, 12, 1, false)
VALUE(FP_MARGIN_QS, 128, 20, 500, 20, true)

VALUE(SEEP_MARGIN_QS, -16, -250, 0, 20, true)
...
VALUE(HS_BONUS_COEF, 178, 50, 500, 20, true)
VALUE(HS_BONUS_BIAS, -50, -250, 0, 20, true)
VALUE(HS_BONUS_MAX, 985, 500, 2500, 100, true)

VALUE(CORR_WEIGHT_PAWN, 32, 16, 128, 16, true)
