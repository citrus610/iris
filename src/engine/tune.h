...
VALUE(NMP_RED_EVAL_MAX, 3, 1, 5, 1, false)
VALUE(NMP_DIV_DEPTH, 5, 2, 8, 1, false)
VALUE(NMP_DIV_EVAL, 160, 50, 500, 20, false)
...
VALUE(HS_BONUS_COEF, 178, 50, 500, 10, true)
VALUE(HS_BONUS_BIAS, -50, -250, 0, 5, true)
VALUE(HS_BONUS_MAX, 1500, 500, 2500, 50, true)
VALUE(HS_BONUS_CUT_COEF, 64, 16, 512, 10, false)

VALUE(HS_MALUS_COEF, 150, 50, 500, 10, true)
VALUE(HS_MALUS_BIAS, -50, -250, 0, 5, true)
VALUE(HS_MALUS_MAX, 1000, 500, 2500, 50, true)

VALUE(CORR_WEIGHT_PAWN, 64, 16, 128, 8, false)
VALUE(CORR_WEIGHT_NON_PAWN, 32, 16, 128, 8, false)
VALUE(CORR_WEIGHT_MINOR, 32, 16, 128, 8, false)
VALUE(CORR_WEIGHT_MAJOR, 32, 16, 128, 8, false)
