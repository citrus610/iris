...
VALUE(RAZOR_COEF, 292, 100, 500, 10, true)

VALUE(RFP_DEPTH, 8, 6, 12, 1, false)
VALUE(RFP_COEF, 69, 20, 100, 10, true)
...
VALUE(NMP_DIVISOR_EVAL, 160, 50, 500, 20, true)

VALUE(LMP_BASE, 3, 3, 3, 0, false)

VALUE(FP_COEF, 88, 50, 500, 10, true)
VALUE(FP_BIAS, 79, 0, 250, 10, true)
VALUE(FP_DEPTH, 10, 8, 12, 1, false)
VALUE(FP_MARGIN_QS, 129, 20, 500, 10, true)

VALUE(SEEP_MARGIN_QS, 0, -250, 0, 10, true)
VALUE(SEEP_MARGIN_QUIET, -76, -250, -50, 10, true)
VALUE(SEEP_MARGIN_NOISY, -15, -50, -10, 5, true)
