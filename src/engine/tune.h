...
VALUE(LMR_HIST_QUIET_DIV, 8192, 1024, 16384, 512, true)
VALUE(LMR_HIST_NOISY_DIV, 5800, 1024, 16384, 512, true)
...
VALUE(PROBCUT_DEPTH, 5, 3, 10, 1, false)
VALUE(PROBCUT_MARGIN, 250, 100, 500, 10, false)
VALUE(PROBCUT_REDUCTION, 4, 2, 8, 1, false)
